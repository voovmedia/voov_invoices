    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.currency.add_currency') }}</h2>
            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('icon', null, ['id' => 'icon', 'class' => 'form-control ', 'required', 'placeholder' => __('messages.currency.icon')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('code', __('messages.currency.currency_code') . ':', ['class' => 'required mb-2']) }}
                        {{ Form::text('code', null, ['class' => 'form-control  mb-3 mb-lg-0', 'placeholder' => __('messages.currency.currency_code'), 'required']) }}
