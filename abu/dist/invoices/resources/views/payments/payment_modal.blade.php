            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    <div class="form-group col-lg-4 col-sm-12 mb-5">
                        ...
                        {{ Form::select('invoice_id', $invoice, null,['id'=>'invoice_id','class' => 'form-select  invoice ','placeholder'=>__('messages.invoice.invoice'),'required','data-control' =>'select2']) }}
                    </div>
                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-sm-12 mb-5">
                        ...
                        {{ Form::text('payment_mode','Cash',['id'=>'adminPaymentMode','readonly','class' => 'form-control  ']) }}
                    </div>
