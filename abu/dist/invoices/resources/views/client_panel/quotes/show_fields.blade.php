                                        ...
                                        <table class="table table-striped box-shadow-none mt-4">
                                            ...
                                            <tbody>
                                                @foreach ($quote->quoteItems as $index => $quoteItem)
                                                    <tr>
                                                        <td class="py-4">
                                                            {{ isset($quoteItem->product->name) ? $quoteItem->product->name : $quoteItem->product_name ?? 'N/A' }}
                                                        </td>
                                                        <td class="py-4">{{ $quoteItem->quantity }}</td>
                                                        <td class="py-4 text-end min-width-130px">
                                                            {{ isset($quoteItem->price) ? getCurrencyAmount($quoteItem->price, true) : 'N/A' }}
                                                        </td>
                                                        <td class="py-4 text-end min-width-130px">
                                                            {{ isset($quoteItem->total) ? getCurrencyAmount($quoteItem->total, true) : 'N/A' }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-gray-900 text-end pe-0">
                                                            {{ isset($quote->amount) ? getCurrencyAmount($quote->amount, true) : 'N/A' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
