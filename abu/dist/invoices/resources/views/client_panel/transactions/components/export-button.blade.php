<div class="dropdown my-3 my-sm-3">
    ...
    <ul class="dropdown-menu export-dropdown">
        <a href="{{ route('client.transactionsExcel') }}" class="dropdown-item" data-turbo="false">
            <i class="fas fa-file-excel me-1"></i> {{ __('messages.invoice.excel_export') }}
        </a>
        <a href="{{ route('client.export.transactions.pdf') }}" class="dropdown-item" data-turbo="false">
