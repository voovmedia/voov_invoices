                        ...
                        <tr>
                            <td class="p-0 m-0" style="width:66%; overflow:hidden !important;  ">
                                <div class="bg-white h-125px" style=" border-top-right-radius:30px; padding:24.5px;">
                                    <img width="100px" height="66px" src="{{ getLogoUrl() }}" class="img-logo"
                                        alt="logo">
                                </div>
                            </td>
                    ...
                    <div class="px-4 py-4 bg-white" style="margin-right:10px;">
                        ...
                        <div class="mb-5">
                            ...
                            <p class="font-gray-600">{!! nl2br($quote->note ?? __('messages.common.n/a')) !!}
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestiae sint eius
                                repellat ullam! Ut molestias eum quam nobis aspernatur tempore dolores! Accusamus,
                                cumque! Explicabo delectus vero dolorem inventore rerum consequatur.
                            </p>
                        </div>
                        <div class="w-75">
                            ...
                            <p class="font-gray-600 mb-0">{!! nl2br($quote->term ?? __('messages.common.n/a')) !!}
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Explicabo minus cupiditate
                                rem voluptatem illum dolores reprehenderit fuga, corporis quos odio quia quasi,
                                consequuntur totam pariatur officiis tempora laudantium? Suscipit, a!</p>
                        </div>
                        <div class="w-25 text-end" style="position:relative; margin-left:auto; top:-70px;">
                            <h5 class="text-indigo mt-2" {{ $styleCss }}="color:{{ $invoice_template_color }}">
