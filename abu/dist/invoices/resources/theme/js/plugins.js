  ...
  \**************************************************/
            /***/ (
                ...
                function cleanupAttributes(el, names) {
                    ...
                    Object.entries(el._x_attributeCleanups).forEach(
                        ([name, value]) => {
                    ...
                    for (let i = 0; i < mutations.length; i++) {
                        ...
                        if (mutations[i].type === "childList") {
                            mutations[i].addedNodes.forEach(
                                (node) =>
                                    node.nodeType === 1 && addedNodes.push(node)
                            );
                    ...
                    let thisProxy = new Proxy(
                        {},
                        {
                            ownKeys: () => {
                                return Array.from(
                                    new Set(
                                        objects.flatMap((i) => Object.keys(i))
                                    )
                                );
                            },
                            has: (target, name) => {
                                ...
                                return (objects.find((obj) => {
                                    if (obj.hasOwnProperty(name)) {
                                        ...
                                        if (
                                            ...
                                            getter =
                                                getter &&
                                                getter.bind(thisProxy);
                                            setter =
                                                setter &&
                                                setter.bind(thisProxy);
                                            if (getter)
                ...
                function injectMagics(obj, el) {
                    Object.entries(magics).forEach(([name, callback]) => {
                        Object.defineProperty(obj, `$${name}`, {
                            get() {
                                let [utilities, cleanup2] =
                                    getElementBoundUtilities(el);
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
                ...
                function normalEvaluator(el, expression) {
                    ...
                    if (typeof expression === "function") {
                        return generateEvaluatorFromFunction(
                            dataStack,
                            expression
                        );
                    }
                    let evaluator = generateEvaluatorFromString(
                        dataStack,
                        expression,
                        el
                    );
                ...
                function generateEvaluatorFromString(
                    dataStack,
                    expression,
                    el
                ) {
                    ...
                    return (
                        ...
                        if (typeof func === "function") {
                            let promise = func(func, completeScope).catch(
                                (error2) => handleError(error2, el, expression)
                            );
                            if (func.finished) {
                                runIfTypeOfFunction(
                                    receiver,
                ...
                function directives(el, attributes, originalAttributeOverride) {
                    ...
                    let directives2 = Array.from(attributes)
                        .map(
                ...
                function getDirectiveHandler(el, directive2) {
                    ...
                    let fullHandler = () => {
                        ...
                        handler3.inline &&
                            handler3.inline(el, directive2, utilities);
                        handler3 = handler3.bind(
                            handler3,
                            el,
                            directive2,
                            utilities
                ...
                function byPriority(a, b) {
                    let typeA =
                        directiveOrder.indexOf(a.type) === -1
                            ? DEFAULT
                            : a.type;
                    let typeB =
                        directiveOrder.indexOf(b.type) === -1
                            ? DEFAULT
                            : b.type;
                    return (
                        directiveOrder.indexOf(typeA) -
                        directiveOrder.indexOf(typeB)
                    );
                }
                ...
                function registerTransitionsFromClassString(
                    el,
                    classString,
                    stage
                ) {
                ...
                function registerTransitionsFromHelper(el, modifiers, stage) {
                    ...
                    let wantsAll =
                        !modifiers.includes("opacity") &&
                        !modifiers.includes("scale");
                    let wantsOpacity =
                        wantsAll || modifiers.includes("opacity");
                    ...
                    let durationIn =
                        modifierValue(modifiers, "duration", 150) / 1e3;
                    let durationOut =
                        modifierValue(modifiers, "duration", 75) / 1e3;
                ...
                function registerTransitionObject(
                    el,
                    setFunction,
                    defaultValue = {}
                ) {
                        ...
                        if (value) {
                            if (
                                ...
                                (el._x_transition.enter ||
                                    el._x_transition.leave)
                            ) {
                                el._x_transition.enter &&
                                (Object.entries(el._x_transition.enter.during)
                                    .length ||
                                    Object.entries(el._x_transition.enter.start)
                                        .length ||
                                    Object.entries(el._x_transition.enter.end)
                                        .length)
                ...
                function bindInputValue(el, value) {
                    if (el.type === "radio") {
                        ...
                        if (window.fromModel) {
                            el.checked = checkedAttrLooseCompare(
                                el.value,
                                value
                            );
                        }
                ...
                var toReactive = (value) =>
                    isObject(value) ? reactive2(value) : value;
                ...
                directive(
                    "teleport",
                    (el, { expression }, { cleanup: cleanup2 }) => {
                ...
                function isListeningForASpecificKeyThatHasntBeenPressed(
                    ...
                    const selectedSystemKeyModifiers =
                        systemKeyModifiers.filter((modifier) =>
                ...
                directive(
                    ...
                    (
                        ...
                        let evaluateAssignment = evaluateLater(
                            el,
                ...
                function applyBindingsObject(
                    ...
                    getBindings(
                        (bindings) => {
                            let attributes = Object.entries(bindings).map(
                            ...
                            directives(el, attributes, original).map(
                                (handle) => {
                ...
                directive(
                    ...
                    (
                        ...
                        let evaluateItems = evaluateLater(
                            el,
                            iteratorNames.items
                        );
                ...
                function loop(el, iteratorNames, evaluateItems, evaluateKey) {
                    ...
                    evaluateItems((items) => {
                        ...
                        prevKeys = prevKeys.filter(
                            (key) => !removes.includes(key)
                        );
                        ...
                        for (let i = 0; i < keys.length; i++) {
                            ...
                            if (prevIndex === -1) {
                                ...
                                let keyForSpot = prevKeys.splice(
                                    prevIndex - 1,
                                    1
                                )[0];
                ...
                function warnMissingPluginDirective(
                    name,
                    directiveName2,
                    slug
                ) {
  ...
  \******************************************/
            /***/ (
                ...
                var jsrender = __webpack_require__(
                    /*! jsrender */ "./node_modules/jsrender/jsrender.js"
                );

                window.handleSearchDatatable = function (tbl) {
                    var filterSearch = document.querySelector(
                ...
                window.prepareTemplateRender = function (
                    templateSelector,
                    data
                ) {
                ...
                (function (factory, global) {
                    ...
                    function (global, $) {
                        ...
                        var versionNumber = "v1.0.11",
                            ...
                            jsvTmpl = "jsvTmpl",
                            indexStr =
                                "For #index in nested block use #getIndex().",
                        ...
                        function getMethod(baseMethod, method) {
                            ...
                            if ($isFunction(method)) {
                                ...
                                method._d =
                                    ((baseMethod && baseMethod._d) || 0) + 1; // Add flag for derived method (incremented for derived of derived...)
                            }
                            return method;
                        }
                        ...
                        (JsViewsError.prototype = new Error()).constructor =
                            JsViewsError;
                        ...
                        function $viewsDelimiters(openChars, closeChars, link) {
                            ...
                            $subSettings.delimiters = [
                                delimOpenChar0 + delimOpenChar1,
                                delimCloseChar0 + delimCloseChar1,
                                linkChar,
                            ];
                            ...
                            openChars =
                                ...
                                linkChar +
                                ")?\\" +
                                delimOpenChar1; // Default is "{^{"
                            closeChars =
                                "\\" + delimCloseChar0 + "\\" + delimCloseChar1; // Default is "}}"
                        ...
                        function contextParameter(key, value, get) {
                            ...
                            var wrapped,
                                ...
                                storeView = this,
                                isUpdate =
                                    !isRenderCall && arguments.length > 1,
                                store = storeView.ctx;
                            if (key) {
                                if (!storeView._) {
                                    // tagCtx.ctxPrm() call
                                ...
                                callView = storeView;
                                if (
                                    (store && store.hasOwnProperty(key)) ||
                                    (store = $helpers).hasOwnProperty(key)
                                ) {
                                    res = store[key];
                                    if (
                                        key === "tag" ||
                                ...
                                if (
                                    ...
                                    if (!res || !res._cxp) {
                                        ...
                                        storeView =
                                            storeView.tagCtx || $isFunction(res)
                                                ? storeView // Is a tag, not a view, or is a computed contextual parameter, so scope to the callView, no the 'scope view'
                                                : ((storeView =
                                                      storeView.scope ||
                                                      storeView),
                                                  (!storeView.isTop &&
                                                      storeView.ctx.tag) || // If this view is in a tag, set storeView to the tag
                                                      storeView);
                                        if (
                                            res !== undefined &&
                                            storeView.tagCtx
                                            ...
                                            storeView =
                                                storeView.tagCtx.view.scope; // then move storeView to the outer level (scope of tag container view)
                                        }
                                        ...
                                        if (
                                            ...
                                            res._cxp = {
                                                ...
                                                updateValue: function (
                                                    ...
                                                    $.observable(
                                                        res[0]
                                                    ).setProperty(_ocp, val); // Set the value (res[0]._ocp)
                                                    return this;
                                                },
                                            };
                                        }
                                    ...
                                    if ((obsCtxPrm = res && res._cxp)) {
                                        ...
                                        if (arguments.length > 2) {
                                            deps = res[1]
                                                ? $sub._ceo(res[1].deps)
                                                : [_ocp]; // fn deps (with any exprObs cloned using $sub._ceo)
                                        ...
                                        newRes = res[1] // linkFn for compiled expression
                                            ? obsCtxPrm.tag &&
                                              obsCtxPrm.tag.cvtArgs
                                                ? obsCtxPrm.tag.cvtArgs(
                                                      tagElse,
                                                      1
                                                  )[obsCtxPrm.ind] // = tag.bndArgs() - for tag contextual parameter
                                                : res[1](
                                                      res[0].data,
                                                      res[0],
                                                      $sub
                                                  ) // = fn(data, view, $sub) for compiled binding expression
                        ...
                        function convertVal(converter, view, tagCtx, onError) {
                            ...
                            var tag,
                                ...
                                boundTag =
                                    typeof tagCtx === "number" &&
                                    view.tmpl.bnds[tagCtx - 1];
                            ...
                            if (converter || boundTag) {
                                ...
                                if (!tag) {
                                    ...
                                    tagCtx.ctx = extendCtx(
                                        tagCtx.ctx,
                                        (linkCtx ? linkCtx.view : view).ctx
                                    );
                        ...
                        function getResource(resourceType, itemName) {
                            ...
                            if ("" + itemName === itemName) {
                                while (res === undefined && view) {
                                    store =
                                        view.tmpl && view.tmpl[resourceType];
                        ...
                        function renderTag(
                            ...
                            var tag,
                                ...
                                boundTag =
                                    typeof tagCtxs === "number" &&
                                    parentView.tmpl.bnds[tagCtxs - 1];
                            ...
                            if (tagName._is === "tag") {
                                ...
                                tagDef =
                                    parentView.getRsc("tags", tagName) ||
                            ...
                            for (; i < l; i++) {
                                ...
                                if (
                                    ...
                                    if (content && parentTmpl.tmpls) {
                                        tagCtx.tmpl = tagCtx.content =
                                            parentTmpl.tmpls[content - 1]; // Set the tmpl property to the content of the block tag
                                    }
                                    tagCtx.index = i;
                                    ...
                                    tagCtx.ctx = extendCtx(
                                        ...
                                        ctx
                                    ); // Clone and extend parentView.ctx
                                }
                                if ((tmpl = tagCtx.props.tmpl)) {
                                    // If the tmpl property is overridden, set the value (when initializing, or, in case of binding: ^tmpl=..., when updating)
                                    tagCtx.tmpl = parentView._getTmpl(tmpl);
                                    tagCtx.content =
                                        tagCtx.content || tagCtx.tmpl;
                                }
                            ...
                            if (!(tag._er = onError)) {
                                ...
                                for (i = 0; i < l; i++) {
                                    ...
                                    if (!i) {
                                        ...
                                        if (
                                            !tagCtx.args.length &&
                                            tagCtx.argDefault !== false &&
                                            tag.argDefault !== false
                                        ) {
                                            tagCtx.args = args = [
                                                tagCtx.view.data,
                                            ]; // Missing first arg defaults to the current data context
                                        ...
                                        if (
                                            tag._.bnd &&
                                            (linkedElement = tag.linkedElement)
                                        ) {
                                            tag.linkedElement = linkedElement =
                                                $isArray(linkedElement)
                                                    ? linkedElement
                                                    : [linkedElement];

                                            if (
                                                bindToLength !==
                                                linkedElement.length
                                            ) {
                                                error(
                                        ...
                                        if (
                                            (linkedElement = tag.linkedCtxParam)
                                        ) {
                                            tag.linkedCtxParam = linkedElement =
                                                $isArray(linkedElement)
                                                    ? linkedElement
                                                    : [linkedElement];
                                    ...
                                    if (tag.linkedCtxParam) {
                                        ...
                                        m = bindFromLength;
                                        defaultCtx =
                                            tag.constructor.prototype.ctx;
                                        while (m--) {
                                            if (
                                                (ctxPrm = tag.linkedCtxParam[m])
                                            ) {
                                                key = bindFrom[m];
                                                initVal = bdArgs[m];
                                    ...
                                    if (
                                        (mapDef =
                                            props.dataMap || tagDataMap) &&
                                        (args.length || props.dataMap)
                                    ) {
                                        thisMap = tagCtx.map;
                                        if (
                                            !thisMap ||
                                    ...
                                    if (tag.render) {
                                        ...
                                        if (
                                            parentView.linked &&
                                            itemRet &&
                                            !rWrappedInViewMarker.test(itemRet)
                                        ) {
                        ...
                        function View(
                            ...
                            if ((self.parent = parentView)) {
                                ...
                                self.scope =
                                    ((!context.tag ||
                                        context.tag === parentView.ctx.tag) &&
                                        !self.isTop &&
                                        parentView.scope) ||
                                    self;
                                ...
                                if (parentView_.useKey) {
                                    ...
                                    views[
                                        (self_.key = "_" + parentView_.useKey++)
                                    ] = self;
                                    self.index = indexStr;
                        ...
                        function compileTag(name, tagDef, parentTmpl) {
                            ...
                            if ((tmpl = compiledDef.template) !== undefined) {
                                compiledDef.template =
                                    "" + tmpl === tmpl
                                        ? $templates[tmpl] || $templates(tmpl)
                                        : tmpl;
                            }
                            (Tag.prototype = compiledDef).constructor =
                        ...
                        function compileTmpl(name, tmpl, parentTmpl, options) {
                                        ...
                                        if (options) {
                                            ...
                                            if (currentName) {
                                                if (currentName !== jsvTmpl) {
                                                    ...
                                                    value =
                                                        $.data(elem)[jsvTmpl]; // Get cached compiled template
                                                }
                                            }
                            ...
                            if (
                                !tmplOrMarkup &&
                                tmpl.markup &&
                                (tmplOrMarkup = lookupTemplate(tmpl.markup)) &&
                                tmplOrMarkup.fn
                            ) {
                            ...
                            if (tmplOrMarkup !== undefined) {
                                ...
                                if (!compiledTmpl) {
                                    compiledTmpl = $extend(function () {
                                        return compiledTmpl.render.apply(
                                            compiledTmpl,
                                            arguments
                                        );
                                    }, tmpl);
                        ...
                        function compileViewModel(name, type) {
                            ...
                            function iterate(data, action) {
                                ...
                                for (; j < getterCount; j++) {
                                    ...
                                    if (
                                        (ob = data[prop]) === undefined &&
                                        getterType &&
                                        (defaultVal = getterType.defaultVal) !==
                                            undefined
                                    ) {
                            ...
                            function merge(data, parent, parentRef) {
                                ...
                                if ($isArray(model)) {
                                    ...
                                    if ($observable) {
                                        ...
                                        model.splice.apply(
                                            model,
                                            [0, model.length].concat(newModArr)
                                        );
                                    }
                                    return;
                                }
                            ...
                            function unmap() {
                                ...
                                for (prop in model) {
                                    if (
                                        ...
                                        (prop.charAt(0) !== "_" ||
                                            !getterNames[prop.slice(1)]) &&
                                        prop !== $expando &&
                                        !$isFunction(model[prop])
                                    ) {
                                        ob[prop] = model[prop];
                                    }
                                }
                        ...
                        function tmplObject(markup, options) {
                            ...
                            if (!tmpl.htmlTag) {
                                ...
                                tmpl.htmlTag = htmlTag
                                    ? htmlTag[1].toLowerCase()
                                    : "";
                            }
                        ...
                        function renderContent(
                            ...
                            if ((tag = this.tag)) {
                                ...
                                tmpl = view._getTmpl(
                                    tag.template || tagCtx.tmpl
                                );
                                if (!arguments.length) {
                                    data =
                                        tag.contentCtx &&
                                        $isFunction(tag.contentCtx)
                            ...
                            if (tmpl) {
                                ...
                                if (
                                    !isRenderCall ||
                                    $subSettingsAdvanced.useViews ||
                                    tmpl.useViews ||
                                    (view && view !== topView)
                                ) {
                                    result = renderWithViews(
                                        tmpl,
                                        data,
                                        context,
                                        noIteration,
                        ...
                        function renderWithViews(
                            ...
                            if (tag) {
                                ...
                                tagCtx = tag.tagCtx;
                                context = context
                                    ? extendCtx(context, tag.ctx)
                                    : tag.ctx;

                                if (tmpl === view.content) {
                                    // {{xxx tmpl=#content}}
                                    contentTmpl =
                                        tmpl !== view.ctx._wrp // We are rendering the #content
                                    ...
                                    if (tmpl === tag.template) {
                                        ...
                                        contentTmpl =
                                            tagCtx.content || view.content; // Set #content to wrapped block content
                                    }
                                } else {
                            ...
                            if ($isArray(data) && !noIteration) {
                                ...
                                if (itemVar) {
                                    (newView.ctx = $extend({}, newCtx))[
                                        itemVar
                                    ] = $sub._cp(data, "#data", newView);
                                }
                            ...
                            return outerOnRender
                                ? outerOnRender(result, newView)
                                : result;
                        }
                        ...
                        function onRenderError(e, view, fallback) {
                            ...
                            if (
                                $subSettings.onError &&
                                (fallback = $subSettings.onError.call(
                                    view.data,
                                    e,
                                    fallback && message,
                                    view
                            ...
                            return view && !view._lc
                                ? $converters.html(message)
                                : message; // For data-link=\"{... onError=...}"... See onDataLinkedTagChange
                        }
...
*/
                                ...
                                tagName =
                                    tagName ||
                                    ((params = params || "#data"), colon); // {{:}} is equivalent to {{:#data}}
                                ...
                                if (codeTag) {
                                    ...
                                    if (tagName === "else") {
                                        ...
                                        current[10] = markup.substring(
                                            current[10],
                                            index
                                        ); // contentMarkup for block tag
                                        openTagName =
                                            current[11] ||
                                            current[0] ||
                                            syntaxError("Mismatched: " + all);
                                    ...
                                    blockTagCheck(
                                        closeBlock !== current[0] &&
                                            closeBlock !== current[11] &&
                                            closeBlock,
                                        current[0]
                                    ); // Check matching close tag name
                                    current[10] = markup.substring(
                                        current[10],
                                        index
                                    ); // contentMarkup for block tag
                            ...
                            if (isLinkExpr) {
                                if (convertBack !== undefined) {
                                    markup =
                                        markup.slice(
                                            0,
                                            -convertBack.length - 2
                                        ) + delimCloseChar0;
                                }
                                markup =
                                    delimOpenChar0 + markup + delimCloseChar1;
                            }
                            ...
                            function parseTokens(
                                ...
                                function parsePath(
                                    ...
                                    if (object) {
                                        ...
                                        if (!subPath) {
                                            allPath =
                                                (late // late path @a.b.c: not throw on 'property of undefined' if a undefined, and will use _getOb() after linking to resolve late.
                                                    ? (isLinkExpr
                                                          ? ""
                                                          : "(ltOb.lt=ltOb.lt||") +
                                                      "(ob="
                                        ...
                                        if (bindings) {
                                            ...
                                            if (prn && !subPath) {
                                                pathStart[fnDp] = ind;
                                                compiledPathStart[fnDp] =
                                                    compiledPath[fnDp].length;
                                            }
                                        }
                                    }
                                    return allPath;
                                        ...
                                        if (
                                            ...
                                            if (theOb && theOb.sb === newOb) {
                                                compiledPath[fnDp] =
                                                    compiledPath[
                                                        fnDp - 1
                                                    ].slice(theOb._cpPthSt) +
                                                    compiledPath[fnDp];
                                                compiledPath[fnDp - 1] =
                                                    compiledPath[
                                                        fnDp - 1
                                                    ].slice(0, theOb._cpPthSt);
                                            }
                                            newOb._cpPthSt =
                                                compiledPathStart[fnDp - 1];
                                            newOb._cpKey = expr;

                                            compiledPath[fnDp] += full.slice(
                                                prevIndex,
                                                index
                                            );
                                            prevIndex = index;

                                            newOb._cpfn = cpFnStore[expr] =
                                                cpFnStore[expr] || // Compiled function for computed value: get from store, or compile and store
                                                new Function(
                                                    "data,view,j", // Compiled function for computed value in template
                                                    "//" +
                                                        expr +
                                                        "\nvar v;\nreturn ((v=" +
                                                        compiledPath[fnDp] +
                                    ...
                                    : (lftPrn
                                      ...
                                      (space
                                          ...
                                          ? // named param. Remove bindings for arg and create instead bindings array for prop
                                            (fnDp && syntaxError(params),
                                            bindings && pathBindings.pop(),
                                            (named = "_" + path),
                                            (boundName = bound),
                                            (paramIndex = ind + all.length),
                                            bindings &&
                                                ((bindings =
                                                    bndCtx.bd =
                                                    pathBindings[named] =
                                          ...
                                          ? (fnCall[prnDp] ||
                                                syntaxError(params),
                                            ",") // We don't allow top-level literal arrays or objects
                                          : lftPrn0
                                          ? ""
                                          : ((aposed = apos),
                                            (quoted = quot),
                                ...
                                if (bindings) {
                                    ...
                                    compiledPath[fnDp] =
                                        (compiledPath[fnDp] || "") +
                                        full.slice(prevIndex, index);
                                    prevIndex = index + all.length;

                                    if (!aposed && !quoted) {
                                        if (
                                            (lftPrnFCall =
                                                lftPrn && prnStack[prnDp + 1])
                                        ) {
                        ...
                        function buildCode(ast, tmpl, isLinkExpr) {
                            ...
                            if ("" + tmpl === tmpl) {
                                tmplName = isLinkExpr
                                    ? 'data-link="' +
                                      tmpl.replace(rNewLine, " ").slice(1, -1) +
                                      '"'
                                    : tmpl;
                                tmpl = 0;
                            } else {
                                        ...
                                        if ((isElse = tagName === "else")) {
                                            ...
                                            onError =
                                                ...
                                                ($subSettings.debugMode !==
                                                    false &&
                                                    "undefined"); // If debugMode not false, set default onError handler on tag to "undefined" (see onRenderError)
                                            if (
                                                tmplBindings &&
                                                (pathBindings = node[9])
                                            ) {
                                                    ...
                                                    tagRender +
                                                        (tagCtxFn
                                                            ? ((tmplBindings[
                                                              ...
                                                              tmplBindingKey) // Store the compiled tagCtxFn in tmpl.bnds, and pass the key to convertVal()
                                                            : "{" +
                                                              tagCtx +
                                                              "}") +
                                                        ")")
                                            ...
                                            : ((hasTag = true),
                                              "\n{view:view,content:false,tmpl:" + // Add this tagCtx to the compiled code for the tagCtxs to be passed to renderTag()
                                                  (content
                                                      ? nestedTmpls.length
                                                      : "false") +
                                                  "," + // For block tags, pass in the key (nestedTmpls.length) to the nested content template
                                                  tagCtx +
                                                  "},");
                        ...
                        function getTargetSorted(value, tagCtx) {
                            ...
                            if (propParams.sorted) {
                                mapped =
                                    sort || reverse < 0 ? value : value.slice();
                                if (tag.sorted) {
                            ...
                            if (
                                (propParams.start && start === undefined) ||
                                (propParams.end && end === undefined)
                            ) {
                                start = end = 0;
                            }
                            if (!isNaN(start) || !isNaN(end)) {
                                ...
                                start = +start || 0;
                                    ...
                                    end === undefined || end > value.length
                                        ? value.length
                                        : +end;
                        ...
                        function $fnRender(data, context, noIteration) {
                            var tmplElem =
                                    this.jquery &&
                                    (this[0] || error("Unknown template")), // Targeted element not found for jQuery template selector such as "#myTmpl"
                                tmpl = tmplElem.getAttribute(tmplAttr);

                            return renderContent.call(
                                (tmpl && $.data(tmplElem)[jsvTmpl]) ||
                                    $templates(tmplElem),
                                data,
                                context,
                                noIteration
                        ...
                        function dataEncode(text) {
                            ...
                            return "" + text === text
                                ? text.replace(rDataEncode, getCharEntity)
                                : text;
                        }
                        ...
                        function dataUnencode(text) {
                            ...
                            return "" + text === text
                                ? text.replace(rDataUnencode, getCharFromEntity)
                                : text;
                        }
                        ...
                        if (!(jsr || ($ && $.render))) {
                            ...
                            if ($) {
                                ...
                                if ($.observable) {
                                    if (
                                        versionNumber !==
                                        (versionNumber = $.views.jsviews)
                                    ) {
                                        // Different version of jsRender was loaded
                                        throw (
                                            "jquery.observable.js requires jsrender.js " +
                                            versionNumber
                                        );
                                    }
                            ...
                            ($viewsSettings.debugMode = function (debugMode) {
                                return debugMode === undefined
                                    ? $subSettings.debugMode
                                    : ($subSettings._clFns &&
                                          $subSettings._clFns(), // Clear linkExprStore (cached compiled expressions), since debugMode setting affects compilation for expressions
                            ...
                            $tags({
                                ...
                                for: {
                                    ...
                                    render: function (val) {
                                        ...
                                        var value,
                                            ...
                                            props = tagCtx.props,
                                            iterate =
                                                range || tagCtx.args.length, // Not final else and not auto-create range
                                            result = "",
                                            done = 0;
                                        ...
                                        if (!self.rendering.done) {
                                            value = iterate
                                                ? val
                                                : tagCtx.view.data; // For the final else, defaults to current data without iteration.
                                    ...
                                    setDataMap: function (tagCtxs) {
                                        ...
                                        while (l--) {
                                            ...
                                            tagCtx.argDefault =
                                                props.end === undefined ||
                                                tagCtx.args.length > 0; // Default to #data except for auto-create range scenario {{for start=xxx end=yyy step=zzz}}
                                            props.dataMap =
                                                tagCtx.argDefault !== false &&
                                                $isArray(tagCtx.args[0]) &&
                                                (paramsProps.sort ||
                                                    paramsProps.start ||
                                                    paramsProps.end ||
                                                    paramsProps.step ||
                                ...
                                dbg:
                                    ($helpers.dbg = $converters.dbg = dbgBreak), // Register {{dbg/}}, {{dbg:...}} and ~dbg() to throw and catch, as breakpoints for debugging.
                            });
                            ...
                            $converters({
                                ...
                                url: function (text) {
                                    ...
                                    return text != undefined
                                        ...
                                        : text === null
                                        ? text
                                        : ""; // null returns null, e.g. to remove attribute. undefined returns ""
                                },
                            });
                        }
                        ...
                        function (t, e, n) {
                            ...
                            Object.defineProperty(e, "__esModule", {
                                ...
                                (e.stringToNode = function (t) {
                                    ...
                                    return (
                                        (e.innerHTML = t.trim()), e.firstChild
                                    );
                                }),
                            ...
                            (function (e) {
                                !(function (n) {
                                    ...
                                    (i.prototype.catch = function (t) {
                                        ...
                                        (i._setUnhandledRejectionFn = function (
                                            t
                                        ) {
  ...
  \*********************************/
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var sweetalert__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(
                /*! sweetalert */ "./node_modules/sweetalert/dist/sweetalert.min.js"
            );
        /* harmony import */ var sweetalert__WEBPACK_IMPORTED_MODULE_0___default =
            /*#__PURE__*/ __webpack_require__.n(
                sweetalert__WEBPACK_IMPORTED_MODULE_0__
            );
        /* harmony import */ var _custom_datatable__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
                /*! ./custom-datatable */ "./resources/js/custom-datatable.js"
            );
        /* harmony import */ var _custom_datatable__WEBPACK_IMPORTED_MODULE_1___default =
            /*#__PURE__*/ __webpack_require__.n(
                _custom_datatable__WEBPACK_IMPORTED_MODULE_1__
            );
        __webpack_require__(
        ...
        function IOInitDropEffect(box) {
            var area,
                ...
                dropHeight,
                x,
                y; // get clickable area for drop effect
                ...
                $(this)
                    ...
                    .each(function () {
                        if ($collapseMenu.parent().hasClass("show")) {
                            ...
                            $collapseMenu
                                .parents("li")
                                .addClass("active collapse-submenu");
                        }
                    });
            });
        };
