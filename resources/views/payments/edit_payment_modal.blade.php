            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    <div class="form-group col-lg-4 col-sm-12 mb-5">
                        ...
                        {{ Form::text('invoice_id',null,['id'=>'edit_invoice_id','class' => 'form-control ','readonly']) }}
                    ...
                    <div class="form-group col-lg-4 col-sm-12 mb-5 amount d-block">
                        ...
                        <div class="input-group">
                            {{ Form::text('due_amount', null, ['id'=>'totalDue_amount','class' => 'form-control ','placeholder'=>__('messages.invoice.due_amount'),'readonly','disabled']) }}
                    ...
                    <div class="form-group col-lg-4 col-sm-12 mb-5 amount d-block">
                        ...
                        <div class="input-group">
                            {{ Form::text('paid_amount', null, ['id'=>'totalPaid_amount','class' => 'form-control ','placeholder'=>__('messages.invoice.paid_amount'),'readonly','disabled']) }}
                            <a class="input-group-text bg-secondary border-0 text-decoration-none edit-invoice-currency-code" id="autoCode" href="javascript:void(0)"
                               data-toggle="tooltip"
                               data-placement="right" title="Currency Code">
                                {{ getCurrencySymbol() }}
                ...
                <div class="row">
                    <div class="form-group col-lg-4 col-sm-12 mb-5">
                        ...
                        {{ Form::text('payment_date', null, ['class' => 'form-control  ', 'id' => 'edit_payment_date','placeholder'=>__('messages.payment.payment_date'), 'autocomplete' => 'off','required','data-focus'=>"false"]) }}
                    </div>
                    <div class="form-group col-lg-4 col-sm-12 mb-5 amount d-block">
                        {{ Form::label('amount',__('messages.invoice.amount').':', ['class' => 'form-label required mb-3']) }}
                        <div class="input-group">
                            {{ Form::number('amount', null, ['id'=>'edit_amount','class' => 'form-control ','step'=>'any','oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0','required','placeholder'=>__('messages.invoice.amount')]) }}
                            <a class="input-group-text bg-secondary border-0 text-decoration-none edit-invoice-currency-code" id="autoCode" href="javascript:void(0)"
                               data-toggle="tooltip"
                               data-placement="right" title="Currency Code">
                                {{ getCurrencySymbol() }}
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('notes', null, ['id'=>'edit_payment_note','class' => 'form-control ','rows'=>'5','required']) }}
                    </div>
