    ...
    <div>
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tr class="tax-tr">
                    ...
                    <td class="table__item-desc w-25">
                        {{ Form::select('product_id[]', $products, null, ['class' => 'form-select client-product-quote io-select2','required','placeholder'=>__("messages.flash.select_product_or_enter_free_text"),'data-control' => 'select2']) }}
                    </td>
                    <td class="table__qty">
        ...
        <div class="row justify-content-left">
            ...
            <div class="col-lg-6 mb-0 mb-sm-5 mt-0 mt-sm-5" id="quoteNoteAdd">
                {{ Form::label('note', __('messages.quote.note').(':'),['class' => 'form-label fs-6 mb-3']) }}
                {{ Form::textarea('note',null,['class'=>'form-control','id'=>'quoteNote','rows'=>'5']) }}
            </div>
            <div class="col-lg-6 mb-5 mt-5" id="quoteTermRemove">
                {{ Form::label('term', __('messages.quote.terms').(':'),['class' => 'form-label fs-6 mb-3']) }}
