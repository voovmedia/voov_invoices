            ...
            <tbody class="invoice-item-container">
                ...
                <tr class="tax-tr">
                    ...
                    <td>
                        ...
                        {{ Form::number('percentage', $invoice->percentage ?? 0, ['class' => 'form-control percentage', 'id' => 'percentage','oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '0', 'value' => '0', 'step' => '.01', 'pattern' => "^\d*(\.\d{0,2})?$", 'required', 'onKeyPress' => 'if(this.value.length==8) return false;']) }}
