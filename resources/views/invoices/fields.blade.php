<div class="row">
    ...
    <div class="mb-5 col-lg-4 col-sm-12 recurring-cycle-content">
        ...
        {{ Form::number('recurring_cycle', null, ['class' => 'form-control', 'id' => 'recurringCycle', 'autocomplete' => 'off', 'placeholder' => __('messages.flash.number_of_days_for_recurring_cycle'), 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))"]) }}
    </div> -->
    {{-- </div> --}}
    {{-- </div> --}}
    <div class="mb-0">
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tbody class="invoice-item-container">
                    <tr class="tax-tr">
                        ...
                        <td>
                        {{ Form::number('percentage', 0, ['class' => 'form-control percentage', 'id' => 'percentage', 'readonly'=>true, 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '0', 'value' => '0', 'step' => '.01', 'pattern' => "^\d*(\.\d{0,2})?$", 'required', 'onKeyPress' => 'if(this.value.length==8) return false;']) }}
